		...
		return (
			<>
				<main className="main-content">
					...
					<div style={{ margin: "68px auto 0", maxWidth: "1200px", padding: "20px 0", display: 'flex', justifyContent: 'space-between', listStyleType: 'none', paddingLeft: "0"}}>
							...
							trainList.map((train, i) =>
								<li style={card} key={i}>
									...
									<p style={{fontSize: "14px", display: "block", marginBottom: "15px"}}>From: {train.origin_name}</p>
									{
										train.status === "LATE"
										?
										<span style={{fontSize: "14px", background: "red", border: "1px solid red", padding: "5px 10px", display: "inline-block", borderRadius: "3px"}}>
